    ...
    <>
      <Box>
        <form onSubmit={handleSubmit} style={{ padding: "20px" }}>
          <Flex border="1px solid #ccc" borderRadius='5' justify="space-between" align="center" gap='8' p='2px 5px' >
            ...
            <Flex display={toggleTimer ? "flex" : "none"} >
              ...
              <Input
                ...
                placeholder="0:00:00"
              />
            <Button bgColor='#03a9f4' color='#fff' type="submit">ADD</Button>

            <Box>              
              <Button size='xs' variant='transparent' onClick={() => setToggleTimer(false)}><Image src={timerClock} alt='clock' /></Button>
              <Button size='xs' variant='transparent' onClick={() => setToggleTimer(true)}><Image src={list} alt='clock' /></Button>
            </Box>
          </Flex>
        </form>
